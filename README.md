...
### Skills 
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,js,nodejs,jquery,php,mysql,ansible,py,git,grafana,docker,linux,bash,sublime&perline=8)](https://skillicons.dev)
